"""
Django settings for remote_patient_moni_38357 project.
...
ROOT_URLCONF = 'remote_patient_moni_38357.urls'
...
WSGI_APPLICATION = 'remote_patient_moni_38357.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "remote_patient_moni_38357 API",
    "DESCRIPTION": "API documentation for remote_patient_moni_38357 App",
    "VERSION": "v1",
}
