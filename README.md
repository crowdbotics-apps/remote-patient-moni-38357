...
## Project Structure
    ...
    ├── remote_patient_moni_38357  # Django project configurations
...
1. Clone this repo and `cd remote_patient_moni_38357`
...
2. Clone this repo and `cd remote_patient_moni_38357`
